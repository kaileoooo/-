...
<%--        </script>--%>
        ...
        <script type="text/html" id="currentTableBar">
            <a class="layui-btn layui-btn-normal layui-btn-xs data-count-edit" lay-event="make">预约</a>
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'make') {  // 监听修改操作
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '${pageContext.request.contextPath}/bookReader/queryTypeInfoByReader?id='+data.id,
                });
