...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label required">会员到期时间</label>
        <div class="layui-input-block">
            <input type="text" name="menberTime" autocomplete="off" disabled value="<fmt:formatDate value='${info.menberTime}' pattern='yyyy-MM-dd'/>"  class="layui-input">
        </div>
    </div>
